    ...
    inputSchema: {
      ...
      properties: {
        ...
        remotePort: {
          ...
          minimum: 1,
          maximum: 65535,
          description: "Optional exact remote bridge port. Without it, the default App port 37777 is probed.",
        },
      },
      ...
      case "initialize":
        writeResponse(id, {
          ...
          instructions: [
            ...
            "ensure_ports/ping probe the default App port 37777 on physical devices and return discovered bridges.",
